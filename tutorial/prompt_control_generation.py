...
if args.add_control:
    if args.add_pos_example and args.add_neg_example:
        ...
        mytemplate = MixedTemplate(model=plm, tokenizer=tokenizer, text='{"soft":"Write a sentence"} {"soft": "similar to:"} {"soft": "|", "soft_id": 1} {"meta":"pos"} {"soft_id": 1} {"soft": ", different from:"} {"soft_id": 1} {"meta":"neg"} {"soft_id": 1} {"mask"}.')
        ...
        mytemplate = MixedTemplate(model=plm, tokenizer=tokenizer, text='{"soft":"Write a sentence"} {"soft": "similar to:"} {"soft": "|", "soft_id": 1} {"meta":"pos"} {"soft_id": 1} {"mask"}.')
        ...
        mytemplate = MixedTemplate(model=plm, tokenizer=tokenizer, text='{"soft":"Write a sentence"} {"soft": "different from:"} {"soft": "|", "soft_id": 1} {"meta":"neg"} {"soft_id": 1} {"mask"}.')
    else:
        ...
        mytemplate = MixedTemplate(model=plm, tokenizer=tokenizer, text='{"soft":"Write a sentence: "} {"mask"}.')
